...
if __name__ == "__main__":
    ...
    for subset_num in powers_of_two(num_vids):
        ...
        for run_idx in range(10):
            ...
            fvd_score = compute_fvd(args.gen_path, args.gt_path, resolution=args.resolution, sequence_length=args.sequence_length, data_type=args.data_type, conditioning_frames=args.conditioning_frames, subset_num = [])
